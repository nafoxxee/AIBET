...
class AIBetApplication:
    ...
    async def initialize(self):
        ...
        try:
            ...
            if config.telegram.bot_token:
                self.telegram_sender = TelegramSender(config.telegram.bot_token)
    ...
    def _validate_config(self):
        ...
        logger.info(f"   - Админы: {len(config.admin_telegram_ids)} пользователей")
        ...
        try:
            ...
            if self.telegram_sender:
                telegram_task = asyncio.create_task(
                    self.telegram_sender.dp.start_polling()
                )
    ...
    async def _health_check(self):
        ...
        try:
            ...
            if self.telegram_sender:
                try:
                    bot_info = await self.telegram_sender.bot.get_me()
    ...
    async def _send_startup_message(self):
        ...
        try:
            ...
            if config.telegram.cs2_channel_id:
                await self.telegram_sender.bot.send_message(
    ...
    async def stop(self):
        ...
        try:
            ...
            if self.telegram_sender:
                await self.telegram_sender.dp.stop_polling()
                await self.telegram_sender.bot.session.close()
