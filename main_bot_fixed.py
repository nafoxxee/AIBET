#!/usr/bin/env python3
"""
AIBOT - БОТ ТЕЛЕГРАММ (Fixed for Render)
Optimized for Render Free Tier with HTTP server for health checks
"""
...
app = FastAPI(title="AIBOT Health Check", version="1.0.0")
...
async def main():
    ...
    try:
        ...
        logger.info(f"🎯 AIBOT Service запущен на порту {config.port}")
